...
public class TheFragment5_ExtScrollListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BottomNavigationViewPager.Fragments.TheFragment5+ExtScrollListener, BottomNavigationViewPager", TheFragment5_ExtScrollListener.class, __md_methods);
	}


	public TheFragment5_ExtScrollListener ()
	{
		super ();
		if (getClass () == TheFragment5_ExtScrollListener.class)
			mono.android.TypeManager.Activate ("BottomNavigationViewPager.Fragments.TheFragment5+ExtScrollListener, BottomNavigationViewPager", "", this, new java.lang.Object[] {  });
	}
